...
public class YidianAdapter extends ArrayAdapter<OrderDetail>{
	  private int  resourceId;
	  private ViewHolder viewHolder;
	  private OrderDB orderdb;
	  public YidianAdapter(Context context,int textViewResourceId,List<OrderDetail> objcts){
	  ...
	  public View getView(int i, View converView, ViewGroup viewGroup) {
          ...
          viewHolder.yidian_item1.setText(menu.getName().toString());
          viewHolder.yidian_item2.setText(menu.getPrice().toString());
