...
public class LoginForAdd extends Activity{
        ...
        mydialog.setYesOnclickListener(name, new MyDialog.onYesOnclickListener() {  
            ...
            public void onYesClick() {  
            	if(validate2()){
            		...
            		Toast.makeText(LoginForAdd.this,"登录成功",Toast.LENGTH_LONG).show();
    				Intent intent=new Intent(LoginForAdd.this, AddDish.class);
